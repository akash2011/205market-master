...
<div class="gray-mpu">
  <div class="container">
    ...
    <?php include (TEMPLATEPATH . '/mpu5-sub.php'); ?>
  </div>
  <!--/container-->
    ...
    <div id="section-16" class="row">
      <div class="col-md-6 text-align-center">
        ...
        <table border="0" cellspacing="0" cellpadding="4" style="width: 70%;margin: 10px auto 0 auto;">
          <tbody>
            <tr>
              <th align="center" valign="top" scope="row"> <center>
            ...
            <tr>
              <td width="120" align="center" valign="top" scope="row"><p class="icon-txt">INTELLIGENT<br> TETHER</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">INTEGRATED <br>GPS</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">HD VIDEO <br>STREAMS</p></td>
            </tr>
          </tbody>
        </table>
		</center>
      ...
      <div class="col-md-6 text-align-center">
        ...
        <table border="0" cellspacing="0" cellpadding="4" style="width: 70%;margin: 10px auto 0 auto;">
          <tbody>
            ...
            <tr>
              <td width="120" align="center" valign="top" scope="row"><p class="icon-txt">REDUCED <br>SWaP</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">INTEGRATED <br>ANDROID™</p><br></td>
                <td width="120" align="center" valign="top"><p class="icon-txt">WAVE RELAY<sup>®</sup> <br>MANET</p></td>
            </tr>
          </tbody>
        </table>
		</center>
      ...
      <div class="col-md-6 text-align-center margin-25">
        ...
        <table border="0" cellspacing="0" cellpadding="4" class="left-15">
          <tbody>
            ...
            <tr>
              <td width="120" align="center" valign="top" scope="row"><p class="icon-txt">1080P/30FPS <br>720P/60FPS</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">VIDEO <br>ENCODING</p><br></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">THE RANGE</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">STREAMING</p></td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div id="section-22" class="row">
      <div class="col-md-6">
        ...
        <p class="mpu mpu-grey">In any emergency, the first systems to fail are cell towers and fixed infrastructure. Arrive prepared and instantly establish a mobile high speed network anywhere simply by turning the MPU5 on. <br>
          <br>
          Know where your teammates are located and coordinate across agencies seamlessly by leveraging integrated Radio over IP.  Your communication does not have to become the second disaster. </p>
      </div>
      <div class="col-md-6 text-align-center margin-25">
        <figure>
          <video class="rollover-vid" loop autoplay>
        ...
        <table border="0" cellspacing="0" cellpadding="4" class="left-30">
          <tbody>
            ...
            <tr>
              <td width="120" align="center" valign="top" scope="row"><p class="icon-txt">GPS<br>INTEGRATED</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">INTELLIGENT<br>TETHER</p><br></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">PEER TO PEER<br>ROUTING</p></td>
            </tr>
          </tbody>
        </table>
      </div>
	  ...
	  <center>
        ...
        <table border="0" cellspacing="0" cellpadding="4" >
          <tbody>
            ...
            <tr>
              <td width="120" align="center" valign="top" scope="row"><p class="icon-txt">INTEGRATED <br>ANDROID<sup style="font-size:6px;">TM</sup></p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">REDUCED <br>SWaP</p><br></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">HD VIDEO <br>STREAMS</p></td>
              <td width="120" align="center" valign="top"><p class="icon-txt">COMMAND &amp; <br> CONTROL</p></td>
            </tr>
          </tbody>
        </table>
	  </center>
    ...
    <div id="section-25" class="row">
      <div class="col-md-12 text-align-right">
        <div class="next">
          ...
          <a href="http://www.persistentsystems.com/mpu5-capabilities/"><img src="<?php bloginfo('template_directory'); ?>/images/capabilities.png" class="btn"></a> </div>
      </div>
    </div>
